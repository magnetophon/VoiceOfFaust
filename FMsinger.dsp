...
process(audio) = stereoFMSynth(audio:highpass3e(400):extremeLimiter, audio:highpass3e(400),PitchTracker(audio,enablePitchTracker),subLevel(audio))
 // :stereoLimiter(PitchTracker(audio,enablePitchTracker)*0.5)
  ;
